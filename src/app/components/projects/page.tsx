        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-wrap items-center w-full mb-12">
            <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
              ...
              <div className="h-1 w-24 bg-blue-400 rounded mt-2"></div>
            </div>
          ...
          >
            {projects.map((project, index) => (
              ...
              >
                ...
                <h3 className="text-xs font-medium text-blue-400 tracking-widest uppercase">{project.type}</h3>
                ...
                <a
                  ...
                  className="mt-4 px-6 py-2 bg-blue-400 text-white font-medium rounded-lg hover:bg-blue-500 transition-all duration-300"
                >
                  View Project
                </a>
              </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 mt-2">Check out my LinkedIn for more previous and upcoming projects!</p>
            <a
              href="https://www.linkedin.com/in/mubashir-khan-538a662bb"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-4 px-6 py-3 bg-blue-400 text-white font-medium rounded-lg hover:bg-blue-500 transition-all duration-300"
            >
              Visit LinkedIn
            </a>
          </motion.div>
