          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap items-center justify-between">
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed text-lg">
                I completed my school education at <strong>Metropolitan Academy</strong>, 
                securing 63% in my ninth-grade exams and 65% in matriculation, specializing 
                in Computer Science 📚🎓. In January 2024, I joined a prestigious skill 
                enhancement program launched by <strong>Governor Sindh, Kamran Khan Tessori</strong> 🚀✨, 
                where I am learning modern web development. I <strong>successfully passed Quarter 2 
                of GIAIC 🏆</strong>, further strengthening my technical foundation. With 
                <strong> over a year of hands-on experience 👨‍💻</strong>, I’m building responsive 
                websites and also learning Python 🐍 to diversify my skills.
              </p>
