...
const Contact = () => {
  ...
  const sendEmail = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await emailjs.send(
        process.env.NEXT_PUBLIC_SERVICE_ID!,  // Replace with your actual environment variable or value
        process.env.NEXT_PUBLIC_TEMPLATE_ID!,  // Replace with your actual environment variable or value
        templateParams,
        process.env.NEXT_PUBLIC_USER_ID!      // Replace with your actual environment variable or value
      );
      setSuccess(true);
      setName("");
      setEmail("");
